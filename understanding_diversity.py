...
with st.form("form1", clear_on_submit=True):
    ...
    st.write("In your opinion, how bad is it to kill someone?")
    kill=st_btn_select(('Not bad at all', 'A little bad', 'Somewhat bad', 'Very bad', 'Extremely bad'), key="3")
    st.write("In your opinion, how bad is it to steal someone's belingings?")
    steal=st_btn_select(('Not bad at all', 'A little bad', 'Somewhat bad', 'Very bad', 'Extremely bad'),key="2")
    st.write("In your opinion, how bad is it to talk loudly in public?")
    talk=st_btn_select(('Not bad at all', 'A little bad', 'Somewhat bad', 'Very bad', 'Extremely bad'), key="1")
